...
public class Userdata extends AppCompatActivity {
    ...
    private void showData(String phonenumber) {
        Cursor cursor = new com.example.basicbankingapplication.DatabaseHelper(this).readparticulardata(phonenumber);
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new com.example.basicbankingapplication.DatabaseHelper(Userdata.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
